...
public class CreateValidatorTest {
	...
	public void Create_Checking_14565822_3_point_0_is_valid_for_empty_bank() {
		assertTrue(createValidator.commandIsValid("Create Checking 14565822 3.0"));
	}
	...
	public void Create_Checking_14565822_0_point_2_is_valid_for_empty_bank() {
		assertTrue(createValidator.commandIsValid("Create Checking 14565822 0.2"));
	}

	@Test
	public void Create_Checking_14565822_point_2_is_valid_for_empty_bank() {
		assertTrue(createValidator.commandIsValid("Create Checking 14565822 .2"));
	}

	@Test
	public void Create_Checking_14565822_0_is_valid_for_empty_bank() {
		assertTrue(createValidator.commandIsValid("Create Checking 14565822 0"));
	}

	@Test
	public void Create_Checking_14565822_0_point_0_is_valid_for_empty_bank() {
		assertTrue(createValidator.commandIsValid("Create Checking 14565822 0.0"));
	}

	@Test
	public void Create_Checking_14565822_10_is_valid_for_empty_bank() {
		assertTrue(createValidator.commandIsValid("Create Checking 14565822 10"));
	}

	@Test
	public void Create_Checking_14565822_10_point_0_is_valid_for_empty_bank() {
		assertTrue(createValidator.commandIsValid("Create Checking 14565822 10.0"));
	}
	...
	public void Create_Checking_14565822_10_point_00001_is_invalid() {
		assertFalse(createValidator.commandIsValid("Create Checking 14565822 10.00001"));
	}

	@Test
	public void Create_Checking_14565822_negative_19_is_invalid() {
		assertFalse(createValidator.commandIsValid("Create Checking 14565822 -19"));
	}

	@Test
	public void Create_Checking_78_3_is_invalid() {
		assertFalse(createValidator.commandIsValid("Create Checking 78 3"));
	}

	@Test
	public void Create_Checking_145658234_3_is_invalid() {
		assertFalse(createValidator.commandIsValid("Create Checking 145658234 3"));
	}

	@Test
	public void Create_Checking_145658_point_22_3_is_invalid() {
		assertFalse(createValidator.commandIsValid("Create Checking 145658.22 3"));
	}

	@Test
	public void Create_14565822_3_is_invalid() {
		assertFalse(createValidator.commandIsValid("Create 145658234 3"));
	}

	@Test
	public void Create_Checking_14565822_3_100_is_invalid() {
		assertFalse(createValidator.commandIsValid("Create Checking 145658234 3 100"));
	}

	@Test
	public void Create_Checking_onefourfivesixfiveeighttwotwo_3_is_invalid() {
		assertFalse(createValidator.commandIsValid("Create Checking onefourfivesixfiveeighttwotwo 3"));
	}

	@Test
	public void Create__Checking__14565822__3_is_invalid() {
		assertFalse(createValidator.commandIsValid("Create  Checking  14565822  3"));
	}

	@Test
	public void CreateChecking145658223_is_invalid() {
		assertFalse(createValidator.commandIsValid("CreateChecking145658223"));
	}
	...
	public void Create_Savings_77445566_4_is_valid_for_empty_bank() {
		assertTrue(createValidator.commandIsValid("Create Savings 77445566 4"));
	}
	...
	public void Create_Savings_77445566_4_point_0_is_valid_for_empty_bank() {
		assertTrue(createValidator.commandIsValid("Create Savings 77445566 4.0"));
	}

	@Test
	public void Create_Savings_77445566_0_is_valid_for_empty_bank() {
		assertTrue(createValidator.commandIsValid("Create Savings 77445566 0"));
	}

	@Test
	public void Create_Savings_77445566_10_is_valid_for_empty_bank() {
		assertTrue(createValidator.commandIsValid("Create Savings 77445566 10"));
	}
	...
	public void Create_Savings_77445566_10_point_00001_is_invalid() {
		assertFalse(createValidator.commandIsValid("Create Savings 77445566 10.00001"));
	}

	@Test
	public void Create_Savings_77445566_negative_10_is_invalid() {
		assertFalse(createValidator.commandIsValid("Create Savings 77445566 -10"));
	}

	@Test
	public void Create_Savings_77_10_is_invalid() {
		assertFalse(createValidator.commandIsValid("Create Savings 77 4"));
	}

	@Test
	public void Create_Savings_774455669_4_is_invalid() {
		assertFalse(createValidator.commandIsValid("Create Savings 774455669 4"));
	}

	@Test
	public void Create_Savings_7744_point_5566_4_is_invalid() {
		assertFalse(createValidator.commandIsValid("Create Savings 7744.5566 10.00001"));
	}

	@Test
	public void Create_Savings_77445566_4_5000_is_invalid() {
		assertFalse(createValidator.commandIsValid("Create Savings 77445566 10 5000"));
	}

	@Test
	public void _77445566_10_Create_Savings_is_invalid() {
		assertFalse(createValidator.commandIsValid("77445566 10 Create Savings"));
	}

	@Test
	public void Savings_is_invalid() {
		assertFalse(createValidator.commandIsValid("Savings"));
	}

	@Test
	public void Create__Savings__77445566__4_is_invalid() {
		assertFalse(createValidator.commandIsValid("Create_Savings_77445566_4"));
	}

	@Test
	public void Create_Savings_77445566_4_is_invalid_for_bank_with_account_with_same_id() {
		bank.addAccount("savings", 77445566, 4, 0);
		assertFalse(createValidator.commandIsValid("Create Savings 77445566 4"));
	}
	...
	public void Create_CD_12345678_5_5000_is_valid_for_empty_bank() {
		assertTrue(createValidator.commandIsValid("Create CD 12345678 5 5000"));
	}
	...
	public void Create_CD_12345678_0_point_5_5000_is_valid_for_empty_bank() {
		assertTrue(createValidator.commandIsValid("Create CD 12345678 0.5 5000"));
	}

	@Test
	public void Create_CD_12345678_5_1000_is_valid_for_empty_bank() {
		assertTrue(createValidator.commandIsValid("Create CD 12345678 5 1000"));
	}

	@Test
	public void Create_CD_12345678_5_1000_point_0_is_valid_for_empty_bank() {
		assertTrue(createValidator.commandIsValid("Create CD 12345678 5 1000.0"));
	}

	@Test
	public void Create_CD_12345678_5_10000_is_valid_for_empty_bank() {
		assertTrue(createValidator.commandIsValid("Create CD 12345678 5 10000"));
	}
	...
	public void Create_cd_12345678_5_is_invalid() {
		assertFalse(createValidator.commandIsValid("Create cd 12345678 5"));
	}

	@Test
	public void Create_cd_12345678_is_invalid() {
		assertFalse(createValidator.commandIsValid("Create cd 12345678"));
	}

	@Test
	public void Create_cd_5_is_invalid() {
		assertFalse(createValidator.commandIsValid("Create cd 5"));
	}

	@Test
	public void Create_cd_12345678_5_900_is_invalid() {
		assertFalse(createValidator.commandIsValid("Create cd 12345678 5 900"));
	}

	@Test
	public void Create_cd_12345678_5_11000_is_invalid() {
		assertFalse(createValidator.commandIsValid("Create cd 12345678 5 11000"));
	}

	@Test
	public void Create_cd_12345678_5_negative_5000_is_invalid() {
		assertFalse(createValidator.commandIsValid("Create cd 12345678 5 -5000"));
	}

	@Test
	public void Create_cd_12345678_5_5000dollars_is_invalid() {
		assertFalse(createValidator.commandIsValid("Create cd 12345678 5 5000dollars"));
	}
	...
	public void Create_cd_12345678_17_5000_is_invalid() {
		assertFalse(createValidator.commandIsValid("Create cd 12345678 17 5000"));
	}

	@Test
	public void Create_cd_12345678_negative_3_5000_is_invalid() {
		assertFalse(createValidator.commandIsValid("Create cd 12345678 -3 5000"));
	}

	@Test
	public void Create_cd_123456780_5_5000_is_invalid() {
		assertFalse(createValidator.commandIsValid("Create cd 123456789 5 5000"));
	}

	@Test
	public void Create_cd_12345678_point_0_5_5000is_invalid() {
		assertFalse(createValidator.commandIsValid("Create cd 12345678.0 5 5000"));
	}

	@Test
	public void Createcd1234567855000_is_invalid() {
		assertFalse(createValidator.commandIsValid("Createcd1234567855000"));
	}

	@Test
	public void Create_cd_is_invalid() {
		assertFalse(createValidator.commandIsValid("Create cd"));
	}

	@Test
	public void Create_Madeup_12345678_5_is_invalid() {
		assertFalse(createValidator.commandIsValid("Create Madeup 12345678 5"));
	}
}
